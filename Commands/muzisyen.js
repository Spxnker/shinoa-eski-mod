...
exports.run = async(client, message, args) => {
    ...
    embedCreator("#4D0A0A", ` ${victim} Kişisine <@&${ayarlar.ekstraRoles.muzisyen}> rolü **başarıyla** verildi.`,message,[true,5000])
