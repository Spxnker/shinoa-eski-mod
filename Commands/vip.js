...
exports.run = async(client, message, args) => {
    ...
    embedCreator("#4D0A0A", ` ${victim} Kişisine <@&${ayarlar.ekstraRoles.vip}> rolü **başarıyla** verildi.`,message,[true,5000])
