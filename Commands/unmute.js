...
embedCreator("#4D0A0A", `  ${victim} adlı üyenin yazı/sesli kanallarındaki susturulması \`${reason}\` sebebi ile kaldırıldı. `,message,[true,5000])
};
